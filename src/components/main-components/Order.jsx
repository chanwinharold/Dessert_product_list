...
function Order() {
    return (
        <div className={"max-w-[500px] w-full h-fit rounded-lg bg-white p-8 absolute top-10 left-10"}>
            <div>
